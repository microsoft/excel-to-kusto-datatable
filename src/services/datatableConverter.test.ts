...
import { convertToDatatable, inferColumns, ColumnInfo, KustoDataType, KUSTO_DATA_TYPES } from './datatableConverter';
  ...
  describe('Multi-column mixed types', () => {
    ...
    it('should handle multiple columns with different types', () => {
      const data = [
        ...
        ['Alice', 30, 75000.50, '2020-01-15'],
        ['Bob', 25, 65000.00, '2021-06-01']
      ];
